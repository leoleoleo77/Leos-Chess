...
function activateAI() {
      ...
      if (valueYai !== "1") {
        if (k == "0") {
          if (valueYai === "7" && valueYai !== "2") {
            if ((document.getElementById(valueXai + "." + (Number(valueYai) - 2)).value === " ") && (document.getElementById(valueXai + "." + (Number(valueYai) - 1)).value === " ")) {
              ...
              scoreSystem(valueXai, (Number(valueYai) - 2));
              checkScore(moveID);
            }
          }
        }
        if (k == "1") { 
          if (document.getElementById(valueXai + "." + (Number(valueYai) - 1)).value === " ") {
            ...
            scoreSystem(valueXai, (Number(valueYai) - 1));
            checkScore(moveID);
          } 
        }
        if (k == "2") {
          if (valueXai !== "1") {
            if (document.getElementById((Number(valueXai) - 1) + "." + (Number(valueYai) - 1)).value.slice(0, 1) === "w") {
              ...
              scoreSystem(Number(valueXai) - 1, Number(valueYai) - 1);
              checkScore(moveID);
            }
          }
        }
  ...
  function horseAI (id) {
     horseValue = document.getElementById(id).value
     valueXai = document.getElementById(id).id.slice(0, 1);
     valueYai = document.getElementById(id).id.slice(2, 3);
     for (k = 0; k < 9; k++) {
      tempPoints = 1;
      if (valueYai >= 3) {
        if (valueXai >= 2 && k == 0) {
          if (document.getElementById((Number(valueXai) - 1) + "." + (Number(valueYai) - 2)).value.slice(0, 1) != "w") { 
            moveID = (Number(valueXai) - 1) + "." + (Number(valueYai) - 2);
            scoreSystem(Number(valueXai) - 1, Number(valueYai) - 2);
            checkScore(moveID);
          }
        }
      }
